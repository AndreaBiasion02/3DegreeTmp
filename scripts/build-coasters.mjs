...
for(const [slug,phrase,lines,style,bg,fg] of entries){
 ...
 products.push({slug:pname,name:phrase,description:`Sottobicchiere di laurea con la frase “${phrase}”. Una piccola provocazione da portare al brindisi.`,kind:'coaster',collection:'sottobicchieri-laurea',dimensions:[100,100,4],assembly:'Sottobicchiere rotondo con scritta e grafica a filo della superficie.',image:`/products/${pname}.webp`,model:`/products/${pname}.glb`,openModel:`/products/${pname}.glb`,colors:{structure:bg,accent:fg}});
